...
SECRET_KEY = 'django-insecure-i9@*5rekud9%waoh=fz7k)p9kq%r*2ixah2&ps#87-+2sy+dlu'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'abrarjr66@gmail.com'
EMAIL_HOST_PASSWORD = 'your_email_password'  # Use an app password for Gmail
